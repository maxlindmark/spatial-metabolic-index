...
```{r}
velo2 <- velo |> filter(group == "Plaice_Adult" & quarter == 1)
trends2 <- trends |> filter(group == "Plaice_Adult" & quarter == 1)

# First row!
p1 <- plot_map_fc + 
  geom_raster(data = velo2, aes(X*1000, Y*1000, fill = mean_temp)) +
  scale_fill_viridis(option = "rocket", name = "Mean °C") +
  labs(y = "", x = "") +
...
p3 <- plot_map_fc + 
  geom_raster(data = velo2, aes(X*1000, Y*1000, fill = mean_phi)) +
  scale_fill_viridis(option = "mako", name = "Mean \u03C6") +
  labs(y = "", x = "") +
  theme_sleek(base_size = 8) +
  theme(legend.position = c(0.19, 0.81),
        legend.key.height = unit(0.4, "line"),
...
p4 <- plot_map_fc + 
  ...
  #scale_fill_viridis(option = "rocket", name = "°C trends") +
  scale_fill_gradient2(name = "°C×decade<sup>-1</sup>") +
  theme_sleek(base_size = 8) +
  labs(x = "") +
  theme(legend.position = c(0.19, 0.81),
        legend.key.height = unit(0.4, "line"),
...
p5 <- plot_map_fc + 
  ...
  #scale_fill_viridis(option = "cividis", name = "O<sub>2</sub> trends") +
  scale_fill_gradient2(name = "O<sub>2</sub>×decade<sup>-1</sup>") +
  labs(y = "", x = "") +
  theme_sleek(base_size = 8) +
  theme(legend.position = c(0.19, 0.81),
        legend.key.height = unit(0.4, "line"),
...
p6 <- plot_map_fc + 
  geom_raster(data = trends, aes(X*1000, Y*1000, fill = phi_slope)) +
  #scale_fill_viridis(option = "mako", name = "\u03C6 trends") +
  scale_fill_gradient2(name = "\u03C6×decade<sup>-1</sup>") +
  labs(y = "", x = "") +
  theme_sleek(base_size = 8) +
  theme(legend.position = c(0.19, 0.81),
        legend.key.height = unit(0.4, "line"),
...
p7 <- plot_map_fc + 
  ...
  #scale_fill_viridis(option = "rocket", name = "°C velocities") +
...
p8 <- plot_map_fc + 
  ...
  #scale_fill_viridis(option = "cividis", name = "O<sub>2</sub> velocities") +
  scale_fill_gradient2(name = "km×decade<sup>-1</sup>") +
  theme_sleek(base_size = 8) +
  labs(y = "") +
  theme(legend.position = c(0.19, 0.81),
...
p9 <- plot_map_fc + 
  geom_raster(data = velo2, aes(X*1000, Y*1000, fill = phi_vel)) +
  #scale_fill_viridis(option = "mako", name = "\u03C6 velocities") +
  scale_fill_gradient2(name = "km×decade<sup>-1</sup>") +
  labs(y = "", x = "") +
  theme_sleek(base_size = 8) +
  theme(legend.position = c(0.19, 0.81),
        ...
        plot.margin = unit(c(0,0,0,0), "cm"),
        legend.title = ggtext::element_markdown(size = 6)) + 
  ggtitle("\u03C6 velocities")
  
(p1 + p2 + p3) / (p4 + p5 + p6) / (p7 + p8 + p9) + plot_annotation(tag_levels = "A")

ggsave(paste0(home, "/figures/env_vars_space.pdf"), width = 17, height = 15, units = "cm", device = cairo_pdf)
```
...
velo2 <- velo |> filter(quarter == 1 & life_stage == "Adult")
trends2 <- trends |> filter(quarter == 1 & life_stage == "Adult")
...
p5 <- plot_map_fc + 
  ...
  theme(legend.position = c(0.24, 0.81),
        ...
        plot.margin = unit(c(0,0,0,0), "cm"),
        legend.title = ggtext::element_markdown(size = 6)) + 
  ggtitle("Flounder biomass change")
...
p8 <- plot_map_fc + 
  ...
  theme(legend.position = c(0.19, 0.81),
        ...
        plot.margin = unit(c(0,0,0,0), "cm"),
        legend.title = ggtext::element_markdown(size = 6)) + 
  ggtitle("Flounder velocity change")
...
p9 <- plot_map_fc + 
  ...
  theme(legend.position = c(0.19, 0.81),
        ...
        plot.margin = unit(c(0,0,0,0), "cm"),
        legend.title = ggtext::element_markdown(size = 6)) + 
  ggtitle("Plaice velocity change")
